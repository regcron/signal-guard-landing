            ...
            <Card className="p-6 shadow-lg">
              <CardContent className="p-0">
                <div className="space-y-8">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold mb-4 text-primary">3. Risk Disclosure</h2>
                    <p className="text-muted-foreground leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold mb-4 text-primary">4. User Accounts</h2>
                    <p className="text-muted-foreground leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold mb-4 text-primary">5. Subscription and Billing</h2>
                    <p className="text-muted-foreground leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold mb-4 text-primary">6. API Usage and Security</h2>
                    <p className="text-muted-foreground leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold mb-4 text-primary">12. Contact Us</h2>
                    <p className="text-muted-foreground leading-relaxed">
